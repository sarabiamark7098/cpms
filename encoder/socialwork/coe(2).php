 <?php 
    ...
    if(isset($_GET['id'])){
        ...
        $address .= $clientbarangay[0].", ". $clientmunicipality[0] .", ". $cliecntprovince[0];
                    ...
                    <div class="card border-info mb3" style="width:100%;">
                        ...
                        <div class="card-body">
							   ...
							   <?php if($am > 5000 || $am2 > 5000){ ?>
                                ...
                                <?php }
                                ?>
                                <div class="col" style="margin-right:3px"><a href="last.php?id=<?php echo $_GET['id']?>" type="button" class="btn btn-success btn-block text-white" id="Final">Next<span class='fa fa-forward'></span></a></div>
							</div>
						</div>
					</div>
                </div>
