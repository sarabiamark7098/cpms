<?php 
    ...
    if(isset($_GET['confirmdone'])){
        if($_GET['confirmdone'] == 1){
            ...
            $user->enc_done($_GET["id"],$_GET['transid']);
        }
    }
    if(isset($_GET['id'])){
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <input type="number" class="form-control mr-sm-2 b" id="c_no" value="' .$gl['control_no']. '" name="c_no" placeholder="Control No." readonly>
    ...
    <?php 
        ...
        if(isset($_POST['update'])){
            ...
            if( $if1 || $if2 ){
                ...
                $user->updateGLCashbyEncoder($_GET['id'], $sd_officer, $c_no, $signatory, $addressee, $a_pos, $cname, $add);
                ...
                if((strtolower($mode1) == "cav" || strtolower($mode2) == "cav")){
                    ...
                    if(empty($gl)){
                        ...
                        $user->updateGLbyEncoder($_GET['id'], $c_no, $signatory, $addressee, $a_pos, $cname, $add);
                    }
                }
