            ...
            <div class="col " style="border: 1px solid black;padding-top: 8px;margin-top: 3px; padding-bottom: 3px;">
                ...
                <div class="row" style="font-size: 14px;">
                    ...
                    <div class="col" style="padding-top: 0px; margin-top: -8px;">
                        ...
                        <input class="text-center" style="width: 100%;height:20px; font-size: 11px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value="<?php echo $record['others_input']?>">
                        <?php } else {?>
...
<br>
        ...
        <div class="row" style="font-size: 15px; line-height: 15px;">
			...
			<?php } else { 
				if($am > 50000 &&  $gis['signatory_id'] != $client['signatory_GL']){?>
                <div class="col text-center">
        ...
        <div class="row">
            <div class="col-6">
                <div style=" margin-top: -15px;"<?php echo $user->casestudy('social case', $record['document'], $am)?> >
                    <b style="font-size:16px;">NOTE: <label style="text-indent: 40px"> CASE STUDY REPORT ON FILE</label></b>
                </div>
            </div>
            <div class="col-6">
