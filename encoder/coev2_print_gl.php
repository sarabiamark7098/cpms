    ...
    <div class="container" id="coev2_print" style="font-size:15px; padding:0%;">
        ...
        <div class="row">
            ...
            <div class="col" style="margin-left: -80px;">
                <input class="text-center" style="height: 22%; width: 85%; font-size: 15px; border-bottom: 1px solid black;" value="AICS Fund"></input><br>
                <input class="text-center" style="height: 22%; width: 85%; font-size: 15px; border-bottom: 1px solid black;" value="<?php echo $client["category"]; ?>"></input><br>
                <input class="text-center" style="height: 22%; width: 85%; font-size: 15px; border-bottom: 1px solid black;" value="<?php echo $gl["cname"]; ?>"></input><br>
