        ...
        <div id="content">
            ...
            <div class="container">
                <div class="table-responsive-lg">
                    <div class="span6" style="float: none; margin: 0 auto; text-align: center;">
                        <form action="import.php" enctype="multipart/form-data" method="post" role="form">
                            <div class="form-group row">
                                <div class="col-sm-2"></div>
                                <div class="col-sm-8">
                                    <select class="form-control mr-sm-2 b" name="office" id="office" required>
