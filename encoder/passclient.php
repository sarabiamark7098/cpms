	...
	<div class="body">
	  <form class="form-group" action="passclient.php?id=<?php echo $clientid?>&trans_id=<?php echo $getClient['trans_id'] ?>" method="POST">
	 	<div class="modal-body">
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input value="<?php echo $getClient['firstname'] ?>" type="text" name="firstname" class="form-control mr-sm-2 b" style="text-transform:uppercase" placeholder="First Name" required >
					...
					<?php
						...
						foreach($getregions as $index => $value){
						  //Display info
							...
							echo '<option value="'. $value['psgc_name'] .' /'. $value['psgc_code'] .'"> ';
			...
			<div class="form-group row">
				<div class="col-sm-12">
				<input list="barangayClist" id="brgy" value="<?php echo $getClient['client_barangay'] ?>" type="text" class="form-control mr-sm-2 b" name="Cbarangay" placeholder="Barangay" required >
