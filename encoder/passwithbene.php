...
$user = new User();
	...
	if(isset($_POST['pass'])){
		...
		$execute = $user->insertClientWithTheSameBenePass($transid, $fname, $mname, $lname, $exname, $sex, $bday, $occupation, $salary, 
		$category, $subCategory, $civilStatus, $contact, $region, $province, $city_mun, $barangay, $district, $street, $relationship, 
		$b_fname, $b_mname, $b_lname, $b_exname, $b_bday, $b_sex, $b_civilStatus, $b_contact, $b_category, $b_subCat, $b_region, 
		$b_province, $b_city_mun, $b_district, $b_barangay, $b_street, $note);
	...
	<div class="body">
	  <form class="form-group" action="passwithbene.php?id=<?php echo $clientid?>" method="POST">
	 	<div class="modal-body">
			...
			<div class="col-sm-6">
				...
				<select name="civilstatus" class="form-control mr-sm-2 b" required >
					...
					if($getClient['civil_status'] == ''){
						...
						echo '<option value="Widow/Widower">Widow/Widower</option>';
						echo '<option value="Common-Law">Common-Law</option>';
					}elseif($getClient['civil_status'] == 'Widow/Widower'){
						echo '<option value="" disabled>Civil Status</option>';
						echo '<option value="Single">Single</option>';
						echo '<option value="Married">Married</option>';
						echo '<option value="Separated">Separated</option>';
			...
			<div class="form-group row">
				<div class="col-sm-12">
				<input list="barangayClist" id="cbrgy" value="<?php echo $getClient['client_barangay'] ?>" type="text" class="form-control mr-sm-2 b" name="Cbarangay" placeholder="Barangay" required>
			...
			<div class="form-group row">
				<div class="col-sm-12">
				<input type="text" value="<?php echo $getClient['client_street'] ?>" class="form-control mr-sm-2 b" name="Cstreet" placeholder="No./Street/Purok">
				<label>Street</label>
				</div>
			</div>
			...
			<div id="collapseCheck" aria-expanded="false">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" value="<?php echo $getClient['b_subCategory'] ?>" class="form-control mr-sm-2 b" name="b_subcat" placeholder="Beneficiary Sub-Category" >
					</div>
				</div>
				...
				<div class="form-group row">
					<div class="col-sm-12">
					<input type="text" value="<?php echo $getClient['b_street'] ?>" class="form-control mr-sm-2 b" name="b_street" placeholder="Beneficiary No./Street/Purok">
					</div>
				</div>
			</div>
		</div>
