<?php
    ...
    public function insertGL($id, $control_no, $signatory, $addressee, $a_pos, $forthe, $cname, $add, $tomention){
		...
		$query = "INSERT INTO gl (trans_id, control_no, addressee, position, to_mention, for_the_id, cname, caddress, c_no) 
                    VALUES 
					('{$id}', '{$final_control_no}', '{$addressee}', '{$a_pos}', '{$tomention}', '{$forthe}', '{$cname}', '{$add}', '{$final_control_no}');";
