...
<html>
   ...
   <div class="container" style="position: static"><br>
        <div>
			...
			<button class="btn btn-success btn-block" onclick="back('<?php echo $_GET['id']?>')" data-id="<?php echo $id ?>"><span class='fa fa-arrow-left'></span> Cancel</button></div>
                ...
                <div class="card border-info mb3" style="width:100%;">
                    ...
                    <div class="card-body text-dark">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col"><input class="form-control money" id="a1" name="a1" <?php echo empty($client_assisstance[1])? "" : "onkeyup='verifyfirst()'" ?>  value="<?php echo empty($client_assisstance[1])? "" : $client_assisstance[1]['amount']; ?>" <?php echo ($updateamountinfive == 1)? "readonly":"" ?>></div>
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col"><input class="form-control money" id="a2" name="a2" <?php echo empty($client_assisstance[2])? "" : "onkeyup='verifysecond()'" ?> value="<?php echo empty($client_assisstance[2]) ? "" : $client_assisstance[2]['amount']; ?>" <?php echo ($updateamountinfive2 == 1)? "readonly":"" ?>></div>
                            <div class="col">
...
if (isset($_POST['update'])) {
    ...
    //once save the data of new -> client
    $user->updateGISbyEncoder($empid, $trans_id, $id, $p1, $p2, $p3, $e1, $e2, $e3, $t1, $t2, $t3, $b1, $b2, $b3, $s1, $s2, $s3, $s4, $ref_name,
    $type1, $pur1, $a1, $m1, $f1,$type2, $pur2, $a2, $m2, $f2, $mode_ad, $num, $gis_opt, $prob, $ass, $signatoryGIS);
}
