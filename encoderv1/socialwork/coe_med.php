<div id='Medic' style="page-break-after:always">
	...
	<div class="container">
		<div class="row">
			...
			<br><p class="text-center" style="font-size:18px;">Republic of the Philippines<br>DEPARTMENT OF SOCIAL WELFARE AND DEVELOPMENT<br>Field Office XI, Davao City<p>
			</div>
		...
		<div class="row">
			<div class="col" style="font-size:18px;">
				...
				&nbsp&nbsp years old and presently residing at 
				<input class="text-center" style="heigth: 100%; width: 75%; text-transform:uppercase" value="<?php echo $address?>"></input> 
		...
		<div class="row">
			<div class="col-3">
				<p>Chargeable Against : <br>Client Category :  <br>Mode of Admission: </p>
			</div>
			<div class="col" style="margin-top:-10px;">
				<!-- <p style=""></p> -->
				<?php if(!empty($fundsourcedata['fundsource2'])){ ?>
				<b><u class="text-center" style="heigth: 90%; width: 50%; font-size: 17px;" ><?php echo $user->getChargableagainst($_GET["id"]);?></u></b><br>
				<?php } else { ?>
				<input class="text-center" style="heigth: 80%; width: 50%;;border:none;border-bottom: 1px solid #000000;border:none;border-bottom: 1px solid #000000;" value="<?php echo $fundsourcedata['fundsource1'];?>"></input><br>
				<?php } ?>
