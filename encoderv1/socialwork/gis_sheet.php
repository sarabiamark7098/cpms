...
<br><br>
    ...
    <div class="row text-center" style="margin:-80px; margin-left: 1px">
        <div class="col-2" style="margin-right: 25px;">
            <input type="text" style="font-weight: bold; text-transform:uppercase;width:130%" class="ubos" id="soc_work" value="<?php echo strtoupper($soc_workFullname); ?>"><br>
            <input type="text" style="width:130%;border:none;text-transform:none;" class="ubos" id="soc_pos" value="CIU-Social Worker">
        </div>
        <div class="col-3">
        ...
        <div class="col-4"  style="margin-left: 50px"><input class="ubos" type="text" id="client" style="width: 75%;" value="<?php echo $client["firstname"]." ". strtoupper($client["middlename"][0]) .". ". $client["lastname"]." ". $client['extraname']; ?>">
        <br><p>Client</p>
        </div>
    </div>
    <!--Container-->    
