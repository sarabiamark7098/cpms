    ...
    <div class="container" id="gisv2_print" style="font-size:12px; padding:0%; font-family: Arial: sans-serif;">
        ...
        <div class="row">
            <div class="col">
                <div class="row" style="font-size:14px;">
                    <b class="text-center">If Medical</b>
                    <div class="col-sm-8" style="margin-left:-20px; font-size:12px;">
                        <div style="padding-top: 3px;">
                            <a style="margin-left: 20px"></a>
                            <input style="width: 10px; margin-left:-5px; width: 20px;padding:0;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_medical'] == 1?"checked":"")?>>Hospital Bill
                            <a style="margin-left: 10px"></a>
                            <input style="width: 10px; margin-left:-5px; width: 20px;padding:0;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_medical'] == 2?"checked":"")?>>Medicine
                            <a style="margin-left: 10px"></a>
                            <input style="width: 10px; margin-left:-5px; width: 20px;padding:0;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_medical'] == 3?"checked":"")?>>Chemotheraphy
                            <a style="margin-left: 10px"></a>
                            <input style="width: 10px; margin-left:-5px; width: 20px;padding:0;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_medical'] == 4?"checked":"")?>>Dialysis
                            <a style="margin-left: 10px"></a>
                            <input style="width: 10px; margin-left:-5px; width: 20px;padding:0;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_medical'] == 5?"checked":"")?>>Procedures
                            <a style="margin-left: 10px"></a>
                            <input style="width: 10px; margin-left:-5px; width: 20px;padding:0;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_medical'] == 6?"checked":"")?>>Laboratory
                            <a style="margin-left: 10px"></a>
                            <input style="width: 10px; margin-left:-5px; width: 20px;padding:0;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_medical'] == 7?"checked":"")?>>Implant
                        </div>
                    </div>
                    <b class="text-center" style="margin-left:-30px;">If Funeral</b>
                    <div class="col-sm-3" style="margin-left:0px; font-size:12px;">
                        <div style="padding-top: 3px;">
                            <a style="margin-right: -10px"></a>
                            <input style="width: 10px; margin-left:-5; width: 20px;padding:0; text-indent: 2px;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_burial'] == 1?"checked":"")?>>Funeral Bill
                            <a style="margin-left: 10px"></a>
                            <input style="width: 10px; margin-left:-5; width: 20px;padding:0; text-indent: 2px;" type="radio" value='1 ' <?php echo ($client_assistance[1]['if_burial'] == 2?"checked":"")?>>Transfer of Cadever
        ...
        <p class="header" style="margin-top: -15px; margin-left: -15px; font-size: 15px;"><b>&emsp; IMPORMASYON NG BENEPISYARYO</b> (Beneficiary's Identifying Information)</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-1" style="margin-top: -5px;">
                                <input class="text-center" style="width: 100%; height:80%; font-size: 13px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo !empty($client["b_bday"])?$beneAge:"" ?>'>
                            </div>
                            <div class="col-2" style="margin-top: -5px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <p class="text-center" style="width: 100%; height:80%; font-size: 10px; "><b>Kasarian</b> (Gender)</p>
                            </div>
                            <div class="col-3">
                                <p class="text-center" style="width: 100%; height:80%; font-size: 10px; "><b>Trabaho</b> (Occupation)</p>
                            </div>
                            <div class="col-2">
                                <p class="text-center" style="width: 100%; height:80%; font-size: 8px; "><b>Buwanang Kita</b> (Monthly Salary)</p>
                            </div>
                        </div>
                        ...
                        <div class="row" style="height: 25px">
                            <div class="col-3">
                                <p class="text-center" style="width: 100%; font-size: 10px; "><b>Numero ng Telepono</b> (Mobile No.)</p>
                            </div>
                            <div class="col-2">
                                <p class="text-center" style="width: 100%; font-size: 10px; "><b>Kapanganakan</b> (Birthdate)</p>
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row">
                            <div class="col-2" style="border: 1px solid black; font-size:11px;">
                                ...
                                <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:2px;border: 1px solid black;" value="<?php echo ($gis['target_sector'] == 4? '&#x2714;':'') ?>" /> &emsp; YOUTH<br>
                                ...
                                <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:2px;border: 1px solid black;" value="<?php echo ($gis['target_sector'] == 6? '&#x2714;':'') ?>" /> &emsp; PLHHIV
                            </div>
								...
								<div class="row" style="font-size: 14px;">
									...
									<div class="col-sm-9" style="margin-left:-30px; margin-bottom:5px; font-size:12px;">
										<div>
											...
											<br>
											<a style="margin-left: 25px"></a>
											<input style="width: 10px; margin-left:-5; width: 20px;padding:0; text-indent: 2px;" type="radio" value='1' <?php echo ($client_assistance[1]['financial'] == 4?"checked":"")?>>Financial Assistance
											<a style="margin-left: 5px"></a>
                        ...
                        <div class="row" style="margin-top: 0px; font-size:14px;">
                            <div class="col-5 text-center" style="border: 1px solid black; background-color: #bfbfbf;">
                                <b>Purpose</b>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-5 text-center" style="border: 1px solid black; font-size: 13px;">
                            ...
                            <div class="col-2 text-center" style="border: 1px solid black; font-size: 13px; line-height:13px">
                                <a><?php echo (!empty($fundsourcedata[1]['fundsource'])?$fundsourcedata[1]['fundsource']."=".$fundsourcedata[1]['fs_amount']:""); ?></a><br>
                        ...
                        <!-- Signatures in GIS -->
                        <div class="row">
                            <div class="col-4 text-center" style="border: 1px solid black; font-size:12px;">
                            ...
                            <div class="col-3 text-center" style="border: 1px solid black; font-size:13px;">
                                ...
                                <b>Interviewed by:</b>
                                <br><br><br>
                                <input class="text-center" style="width: 100%; font-size: 13.5px; padding:0; border:none; border-bottom: 1px solid black; text-transform: uppercase;" type="text" height="30px" value='<?php echo strtoupper($soc_workerFullname); ?>'>
                                <b>Social Worker</b>
                                <p>Signature Over Printed Name</p>
                            </div>
                            <div class="col-3 text-center" style="border: 1px solid black; font-size:13px;">
                                ...
                                <br><br><br>
                                <input class="text-center" style="width: 100%; font-size: 13.5px; padding:0; border:none; border-bottom: 1px solid black; text-transform: uppercase;" type="text" height="30px" value='<?php echo strtoupper($signatoryName) ?>'>
