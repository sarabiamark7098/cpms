...
<style>
    ...
    <div class="container" id="coev2_print" style="font-size:12px; padding:0%;">
        ...
        <div class="row">
            <div class="col-4">
                <div class="row" style="font-size: 14px; margin-top: -5px">
                    ...
                    <div class="col-sm-10">
                        <input class="" style="width: 18px; font-size: 14px; padding:0; text-indent: 1px; border: 1px solid black;" type="text" value=''>
                        <input class="" style="margin-left:-5; width: 18px; font-size: 14px; padding:0; text-indent: 1px; border: 1px solid black;" type="text" value=''>
                        <input class="" style="margin-left:-5; width: 18px; font-size: 14px; padding:0; text-indent: 1px; border: 1px solid black;" type="text" value=''>
                        <input class="" style="margin-left:-5; width: 18px; font-size: 14px; padding:0; text-indent: 1px; border: 1px solid black;" type="text" value=''>
                        <input class="" style="margin-left:-5; width: 18px; font-size: 14px; padding:0; text-indent: 1px; border: 1px solid black;" type="text" value=''>
                        <input class="" style="margin-left:-5; width: 18px; font-size: 14px; padding:0; text-indent: 1px; border: 1px solid black;" type="text" value=''>
        ...
        <div style="margin-top: 5px; font-size: 14px; text-transform: justify">
            ...
            <input class="text-center" style=" border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 18px; width: 8%;" value="<?php echo (empty($client['b_fname'])?$clientAge:$beneAge) ?>" /> year/s<br>
            <div class="row">
				<div class="col-4"></div>
			...
			value="<?php echo (!empty($client['b_lname'])?$address['beneficiary']:$address['client']) ?>" /><br>
            ...
            <div class="col " style="border: 1px solid black;padding-top: 8px;margin-top: 3px; padding-bottom: 3px;">
                ...
                <div class="row" style="font-size: 14px;">
                    <div class="col" style="padding-top: 0px; margin-top: -8px;">
                        ...
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('valid id', $coe['document'])?>" />&emsp;Valid I.D. Presented:<br>
                        <input class="text-center" style="width: 100%;height:20px; font-size: 11px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo $coe['id_presented']?>'><br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:3px;border:1px solid black;" value="<?php echo $user->coe_check('4ps', $coe['document'])?>" />&emsp;4PS DSWD I.D.<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;margin-bottom:7px;border:1px solid black;" value="<?php echo $user->coe_check('justification', $coe['document'])?>" />&emsp;Justification
                    </div>
                    <div class="col" style="padding-top: 0px; margin-top: -8px;">
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;border:1px solid black;" value="<?php echo $user->coe_check('medical certificate', $coe['document'])?>" />&emsp;Medical Certificate/Abstract<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('prescription', $coe['document'])?>" />&emsp;Prescriptions<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('statement', $coe['document'])?>" />&emsp;Statement of Account<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('treatment', $coe['document'])?>" />&emsp;Treatment Protocol<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('quotation', $coe['document'])?>" />&emsp;Quotation
                    </div>
                    <div class="col" style="padding-top: 0px; margin-top: -8px;">
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;border:1px solid black;" value="<?php echo $user->coe_check('discharge', $coe['document'])?>" />&emsp;Discharge Summary<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('laboratory', $coe['document'])?>" />&emsp;Laboratory Request<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('charge slip', $coe['document'])?>" />&emsp;Charge Slip<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('funeral', $coe['document'])?>" />&emsp;Funeral Contract<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('death certificate', $coe['document'])?>" />&emsp;Death Certificate
                    </div>
                    <div class="col" style="padding-top: 0px; margin-top: -8px;">
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;border:1px solid black;" value="<?php echo $user->coe_check('death summary', $coe['document'])?>" />&emsp;Death Summary<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('referral', $coe['document'])?>" />&emsp;Referral Letter<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('social case study', $coe['document'])?>" />&emsp;Social Case Study Report<br>
                        <?php if(!empty($user->coe_check('others medical', $coe['document']))){ ?>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('others medical', $coe['document'])?>" />&emsp;Others:<br>
                        <input class="text-center" style="width: 100%;height:20px; font-size: 11px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo $coe['others_medical']?>'>
                        <?php } elseif(!empty($user->coe_check('others burial', $coe['document']))){ ?>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('others burial', $coe['document'])?>" />&emsp;Others:<br>
                        <input class="text-center" style="width: 100%;height:20px; font-size: 11px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo $coe['others_burial']?>'>
                        <?php } else {?>
        ...
        <div style="margin-top: 10px; font-size: 14px; text-align:justify;">
			...
			in the amount of <input class="text-center" style="border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 20px; width: 55%;" value="<?php echo $user->toWord($client_assistance[1]["amount"]) ?>"
			...
			<input class="text-center" style="border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 20px; width: 6%;" value="2022" />
        </div>
<br>
        <!-- Signatory -->
        ...
        <div class="row" style="font-size: 15px; line-height: 15px;">
            ...
            <div class="col text-center">
                <input class="text-center" style="width: 100%; font-size: 15px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo strtoupper($soc_workerFullname); ?>'>
                <b>Social Worker</b>
                <p>Signature Over Printed Name</p>
            </div>
            <div class="col text-center">
        ...
        <div class="row">
            <div class="col-12">
                <div class="row" style="font-size: 14px; margin-top: -5px">
                    <div class="col-2">
                        <p class="text-center">Natanggap ko ang</p>
                    </div>
                    ...
                    <div class="col-6 center">
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:6px; border:1px solid black;" value="<?php echo (!empty($client_assistance[1]['financial'])?"&#x2714;":"")?>" />&emsp;Financial Assistance : PHP <input class="text-center" style="border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 20px; width: 30%;"
                            value="<?php echo $client_assistance[1]['amount']; ?>" /> <br>
                        <div style="font-size: 11px;">
                            <!-- <a style=""></a>
                            ...
                            <br>
                            <a style=""></a>
                            <input style="width: 10px; margin-left:-5; width: 20px; padding:0; text-indent: 2px;" type="radio" height="30px" width="100px" value='1 ' <?php echo ($client_assistance[1]['financial'] == 4?"checked":"")?>> Financial Assistance
                            <a style=""></a>
        ...
        <div class="row" style="font-size: 15px; line-height: 15px;">
            ...
            <div class="col text-center">
                <input class="text-center" style="width: 100%; font-size: 15px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo strtoupper($glsignatoryname); ?>'>
                <b><?php echo $glsignatoryposition ?></b>
                <p>Signature Over Printed Name</p>
            </div>
            <div class="col text-center">
                <input class="text-center" style="width: 100%; font-size: 15px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo $soc_workerFullname ?>'>
                <b>Social Worker</b>
                <p>Signature Over Printed Name</p>
            </div>
        </div>
