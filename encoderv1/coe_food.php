	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				...
				<input class="text-center" value="<?php echo empty(substr_count(strval($client_assistance[2]['type']), "Food Sub") > 0)? $client_assistance[1]['type']:$client_assistance[2]['type'] ?>" style="heigth: 100%; width: 30%;;border:none;border-bottom: 1px solid #000000;"></input> 
				&nbsp&nbsp for purpose of &nbsp 
				<input class="text-center" style="heigth: 100%; width: 40%;;border:none;border-bottom: 1px solid #000000;" value="<?php echo empty(substr_count(strval($client_assistance[2]['type']), "Food Sub") > 0)? $client_assistance[1]["purpose"]: $client_assistance[2]["purpose"]?>"></input> 
				&nbsp&nbsp in the amount of 
				<input class="text-center" style="heigth: 100%; width: 70%;;border:none;border-bottom: 1px solid #000000;" value="<?php echo empty(substr_count(strval($client_assistance[2]['type']), "Food Sub") > 0)? $user->toWord($client_assistance[1]["amount"]) : $user->toWord($client_assistance[2]["amount"]);?>"></input> 
				&nbsp&nbsp PHP 
				<input class="text-center" style="heigth: 100%; width: 20%;;border:none;border-bottom: 1px solid #000000;" value="<?php echo empty(substr_count(strval($client_assistance[2]['type']), "Food Sub") > 0)? $client_assistance[1]["amount"]: $client_assistance[2]["amount"] ?>"></input></p>
			</div>
		</div>
		<div class="row">
			<div class="col-3">
		...
		<br>
		<?php if(empty(substr_count(strval($client_assistance[2]['type']), "Food Sub") > 0)){ ?>
		<div class="row">
			<div class="col-5">
				<br><p>Conforme:<br><br>
		...
		<div class="row">
			...
			<?php if($am2 >= $rec_amount) {?>
				<div class="col-5">
					<br><p class="right" style="width: 65%;">Recommending Approval : &nbsp&nbsp&nbsp&nbsp&nbsp <br><br>
					<input class="text-center" style="heigth: 90%; width: 130%; margin-left: 20%;font-weight:bold;text-transform: uppercase;border:none;border-bottom: 1px solid #000000;" value="<?php echo $signatoryName?>">
					<br><input class="text-center" style="margin-left:20%;border:none;width: 130%;" value="<?php echo $signatory['position']?>"/></p>
				</div>
			<?php } elseif($am2 < $rec_amount) {?>
				<div class="col-5">
					<br><p class="right" style="width: 65%;">Approved by : &nbsp&nbsp&nbsp&nbsp&nbsp <br><br>
					<input class="text-center" style="heigth: 90%; width: 130%; margin-left: 20%;font-weight:bold;text-transform: uppercase;border:none;border-bottom: 1px solid #000000;" value="<?php echo $signatoryName?>">
					<br><input class="text-center" style="margin-left:20%;border:none;width: 130%;" value="<?php echo $signatory['position']?>"/></p>
