		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-5">
					...
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_deat" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "DEATH SUMMARY");?></p></td>
			...
			<div class="col">
				<br><input class="text-center" style="heigth: 80%; width: 50%; font-size: 16px;border:none;border-bottom: 1px solid #000000;" value="AICS Fund"></input><br>
				...
				<input class="text-center" style="heigth: 80%; width: 50%;;border:none;border-bottom: 1px solid #000000;border:none;border-bottom: 1px solid #000000;" value="<?php echo strtoupper((strtolower($client["mode_admission"]) == "referral")?"R":"W")?>"></input>
			</div>
		</div>
		<div class="row">
			<div class="col-5">
