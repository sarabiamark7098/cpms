            ...
            <div class="modal-body">
                <div class="row form-group" style="margin-top: 2%; height:10%;">
                    <div class="form-group col-lg-12">
                        <input list="regionClist" id="creg" name="regionname" class="form-control mr-sm-2 b" placeholder="Region" onChange="get_c_Region(this)" required autocomplete="off">
                    ...
                    <div class="form-group col-lg-12">
                        <input list="municipalityClist" type="text" class="form-control mr-sm-2 b" id="client_city" name="city" placeholder="City or Municipality" required autocomplete="off">
