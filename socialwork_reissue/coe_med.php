...
?>
	...
	<br><br>
		<div class="container">
			...
			<div class="row">
				<div class="col">
					...
					<input class="text-center" style="heigth: 100%; width: 80%;border:none;border-bottom: 1px solid #000000;"  value="<?php echo $address['client']?>"></input> 
			...
			<div class="row">
				...
				<div class="col-5">
					...
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_med" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "MEDICAL");?></p></td>
						<td style="width: 80%;" class="text-center">MEDICAL CERTIFICATE/ABSTRACT</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_deat" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "DEATH");?></p></td>
						<td style="width: 80%;" class="text-center">DEATH SUMMARY</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_dis" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "DISCHARGE");?></p></td>
						<td style="width: 80%;" class="text-center">DISCHARGE SUMMARY</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_treat" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'],"TREATMENT");?></p></input></td>
						<td style="width: 80%;" class="text-center">TREATMENT PROTOCOL</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_vacc" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "VACCINATION");?></p></td>
						<td style="width: 80%;" class="text-center">VACCINATION</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_lab" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "LAB");?></p></td>
						<td style="width: 80%;" class="text-center">LAB REQUEST</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_charge" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "SLIP");?></p></td>
						<td style="width: 80%;" class="text-center">CHARGE SLIP</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_qout" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "QUOTATION");?></p></td>
						<td style="width: 80%;" class="text-center">QUOTATION</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_pres" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "PRESCRIPTIONS");?></p></td>
						<td style="width: 80%;" class="text-center">PRESCRIPTIONS</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_stat" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "ACCOUNT");?></p></td>
			...
			<div class="row">
				<div class="col">
					...
					<input class="text-center" value="Medical Assistance" style="heigth: 100%; width: 25%; border: none;border:none;border-bottom: 1px solid #000000;"></input> 
			...
			<div class="col">
				<p style="heigth: 60%;"></p>
				<input class="text-center" style="heigth: 90%; width: 40%;;border:none;border-bottom: 1px solid #000000;border:none;border-bottom: 1px solid #000000;" value="<?php echo $user->getChargableagainst($_GET["id"]);?>"></input><br>
				<input class="text-center" style="heigth: 80%; width: 40%;;border:none;border-bottom: 1px solid #000000;font-size:11px;border:none;border-bottom: 1px solid #000000;" value="<?php echo $client["category"];
				if(!empty($client["subCategory"])){
					echo ", ". $client["subCategory"]; 
				}?>"></input><br>
				<input class="text-center" style="heigth: 80%; width: 40%;;border:none;border-bottom: 1px solid #000000;border:none;border-bottom: 1px solid #000000;" value="<?php echo strtoupper($client["mode_admission"])?>"></input>
			</div>
		</div>
		<div class="row">
			<div class="col-5">
			...
			<div class="col ml-md-auto">
				...
				<input class="text-center" style="heigth: 90%; width: 75%; margin-left: 20%;font-weight:bold;text-transform: uppercase;;border:none;border-bottom: 1px solid #000000;" value="<?php echo $soc_workerFullname?>"/> 
				<br><input class="text-center" style="margin-left:10%;border:none;width: 100%;" value="CIU-Social Worker"></input></p>
		...
		<div class="row">
			...
			<?php if($am > 5000) {?>
				<div class="col ml-md-auto">
					...
					<input class="text-center" style="heigth: 90%; width: 75%; margin-left: 20%;font-weight:bold;text-transform: uppercase;border:none;border-bottom: 1px solid #000000;" value="<?php echo $signatoryName?>">
					<br><input class="text-center" style="margin-left:10%;border:none;width: 100%;" value="<?php echo $signatory['position']?>"/></p>
				</div>
			<?php } elseif($am <= 5000) {?>
				<div class="col ml-md-auto">
		...
		<div class="row">
			...
			<div class="col ml-md-auto">
				<br><p class="right" style="width: 65%;">Approved by : &nbsp&nbsp&nbsp&nbsp&nbsp <br><br>
				<input class="text-center" style="heigth: 90%; width: 75%; margin-left: 20%;font-weight:bold;text-transform: uppercase;border:none;border-bottom: 1px solid #000000;" value="<?php echo $reconsignatoryName?>">
				<br><input class="text-center" style="margin-left:10%;border:none;width: 100%;" value="<?php echo $reconsignatory['position']?>"/></p>
			</div>
			<?php } ?>
		</div>	
	</div>
