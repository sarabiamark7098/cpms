...
<div class="container" id="gis_sheet" style="font-size:12px; page-break-after:always">
    ...
    <div class="row text-center" style="margin:-80px; margin-left: 1px">
        <div class="col">
            <input type="text" style="font-weight: bold; text-transform:uppercase;" class="ubos text-center" id="soc_work" value="<?php echo strtoupper($soc_workerFullname); ?>"><br>
            <p>CIU-Social Worker</p>
        </div>
        <div class="col">
            <div style="height: 15px;width:100%;">
                <input type="text" style="font-weight: bold; text-transform:uppercase;" class="ubos text-center" id="signatory" value="<?php echo strtoupper($signatory['first_name']." ". $signatory['middle_I'].". ". $signatory['last_name']); ?>"><br>
                <p><?php echo $signatory['position'] ?></p>
            </div>
        </div>
        <div class="col"></div>
        <div class="col"><input class="ubos text-center" style=" text-transform:uppercase;width:170px;" type="text" id="client" value="<?php echo strtoupper($client["firstname"]." ". strtoupper($client["middlename"][0]) .". ". $client["lastname"]." ". $client['extraname']); ?>">
        <br><p>Client</p>
        </div>
        <div class="col"></div>
    </div>
