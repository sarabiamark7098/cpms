	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-5">
				...
				<tr style="border: solid 1px;">
					<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_regD" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "DEATH CERTIFICATE");?></p></td>
					<td style="width: 80%;" class="text-center">REGISTERED DEATH CERTIFICATE</td>
				</tr>
				<tr style="border: solid 1px;">
					<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_funC" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "FUNERAL");?></p></td>
					<td style="width: 80%;" class="text-center">FUNERAL CONTRACT</td>
				</tr>
				<tr style="border: solid 1px;">
					<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_perT" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "TRANSFER");?></p></td>
					<td style="width: 80%;" class="text-center">PERMIT TO TRANSFER</td>
				</tr>
				<tr style="border: solid 1px;">
					<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_quaP" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "QUARANTINE");?></p></td>
					<td style="width: 80%;" class="text-center">QUARANTINE PERMIT</td>
				</tr>
				<tr style="border: solid 1px;">
					<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_proN" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "PROMISSORY");?></p></td>
		...
		<div class="row">
			<div class="col">
				...
				<input class="text-center" value="<?php echo $client_assistance[1]['type']?>" style="heigth: 100%; width: 25%; border: none;"></input> 
			...
			<div class="col">
				<p style="heigth: 60%;"></p>
				<input class="text-center" style="heigth: 90%; width: 40%;;border:none;border-bottom: 1px solid #000000;" value="<?php echo strtoupper($client_assistance[1]['fund']);?>"></input><br>
				<input class="text-center" style="heigth: 80%; width: 40%;border:none;border-bottom: 1px solid #000000;font-size:11px" value="<?php echo $client["category"];
				if(!empty($client["subCategory"])){
					echo ", ". $client["subCategory"]; 
				}?>"></input><br>
				<input class="text-center" style="heigth: 80%; width: 40%;;border:none;border-bottom: 1px solid #000000;" value="<?php echo strtoupper($client["mode_admission"])?>"></input>
			</div>
		</div>
		<div class="row">
			<div class="col-5">
