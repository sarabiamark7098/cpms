		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-5">
					...
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_regForm" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "registration");?></p></td>
						<td style="width: 80%;" class="text-center">REGISTRATION FORM</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_assForm" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "Assessment");?></p></td>
						<td style="width: 80%;" class="text-center">ASSESSMENT FORM</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_enrolForm" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "Enrollment");?></p></td>
						<td style="width: 80%;" class="text-center">CERTIFICATE OF ENROLLMENT</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_stAcc" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "Statement");?></p></td>
						<td style="width: 80%;" class="text-center">STATEMENT OF ACCOUNT</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><p class="text-center" id="i_sID" style="margin-bottom:-1px"><?php echo $user->returnCheck($coe['document'], "School");?></p></td>
				...
				<div class="col">
					...
					<input class="text-center" value="<?php echo $client_assistance[1]['type']?>" style="heigth: 100%; width: 25%; border: none;border-bottom: 1px solid #000000;"></input> 
			...
			<div class="col">
				<p style="heigth: 60%;"></p>
				<input class="text-center" style="heigth: 90%; width: 40%;;border:none;border-bottom: 1px solid #000000;border:none;border-bottom: 1px solid #000000;" value="<?php echo strtoupper($client_assistance[1]["fund"]);?>"></input><br>
