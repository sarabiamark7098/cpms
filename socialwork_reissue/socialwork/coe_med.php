	...
	<div id='Medic' style="page-break-after:always">
	<br><br>
		<div class="container">
			<div class="row">
				<div class="col">
			...
			<div class="row">
				<div class="col">
					...
					&nbsp&nbsp years old and presently residing at &nbsp&nbsp 
					<input class="text-center" style="heigth: 100%; width: 80%; text-transform:uppercase" value="<?php echo $address?>"></input> 
					&nbsp&nbsp has been eligible for <?php echo $type?> for &nbsp&nbsp 
			...
			<div class="row">
				...
				<div class="col-5">
					...
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('medical', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">MEDICAL CERTIFICATE/ABSTRACT</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('death', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">DEATH SUMMARY</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('discharge', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">DISCHARGE SUMMARY</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('treatment', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">TREATMENT PROTOCOL</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('vaccination', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">VACCINATION</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('lab request', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">LAB REQUEST</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('charge slip', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">CHARGE SLIP</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('quotation', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">QUOTATION</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('prescription', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">PRESCRIPTIONS</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('statement of account', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">STATEMENT OF ACCOUNT</td>
					</tr>
					</table>
				</div>
			</div>
			<div class="row">
				<div class="col-12">
					...
					<input class="text-center" value="<?php echo $type?>" style="heigth: 100%; width: 20%; border: none;"></input> 
					&nbsp&nbsp for purpose of &nbsp 
					<input class="text-center" style="heigth: 100%; width: 40%;" value="<?php echo $client_assistance[1]['purpose']?>"></input> 
					&nbsp&nbsp in the amount of 
					<input class="text-center" style="heigth: 100%; width: 80%;" value="<?php echo $amountToWord?>"></input> 
					&nbsp&nbsp PHP 
					<input class="text-center" style="heigth: 100%; width: 10%;" value="<?php echo $client_assistance[1]['amount'] ?>"></input></p>
				</div>
			</div>
			<div class="row">
				<div class="col-3">
				...
				<div class="col">
					...
					<input class="text-center" style="heigth: 80%; width: 50%;" value="<?php echo $client["category"];
		...
		<div class="row">
			...
			<div class="col ml-md-auto">
				...
				<input class="text-center" style="heigth: 90%; width: 100%; margin-left:25px; font-weight:bold;text-transform: uppercase;" value="<?php echo $soc_worker['empfname'].' '.$soc_worker['empmname'][0].'. '.$soc_worker['emplname'].' '.$soc_worker['empext']?>"/> <br>
				<input class='text-center' style="heigth: 90%; width: 100%; margin-left:25px; border:none" value="CIU-Social Worker"/></p>
		...
		<div class="row">
			...
			<div class="col ml-md-auto">
				<?php if($am <= 5000){ ?>
					<br><p class="right" style="width: 65%;">Approved by : &nbsp&nbsp&nbsp&nbsp&nbsp <br>
					<input class="text-center" style="heigth: 90%; width: 100%; margin-left:25px; font-weight:bold;text-transform: uppercase;" value="<?php echo $GISsignatoryName?>"/><br>
					<input class="text-center" style="heigth: 90%; width: 100%; margin-left:25px;  border:none" value="<?php echo $GISsignatory['position']?>"/></p>
				<?php } elseif($am > 5000){ ?>
					<br><p class="right" style="width: 65%;">Recommending Approval : &nbsp&nbsp&nbsp&nbsp&nbsp <br>
					<input class="text-center" style="heigth: 90%; width: 100%; margin-left:25px; font-weight:bold;text-transform: uppercase;" value="<?php echo $GISsignatoryName ?>"/><br>
					<input class="text-center" style="heigth: 90%; width: 100%; margin-left:25px;  border:none" value="<?php echo $GISsignatory['position']?>"/></p>
				<?php } ?>
			</div>
		...
		<div class="row">
			...
			<div class="col ml-md-auto">
				<?php if($am > 5000){ ?>
					...
					<input class="text-center" style="heigth: 90%; width: 100%; margin-left:25px; font-weight:bold;text-transform: uppercase;" value="<?php echo $COEsignatoryName?>"/><br>
					<input class="text-center" style="heigth: 90%; width: 100%; margin-left:25px;  border:none" value="<?php echo $COEsignatory['position']?>"/></p>
				<?php } ?>
			</div>
		</div>
	</div>
