	...
	<div id='Educ' style="page-break-after:always">
	<br><br>
		<div class="container">
			<div class="row">
				<div class="col">
			...
			<div class="row">
				...
				<div class="col-5">
					...
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('registration', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">REGISTRATION FORM</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('assessment', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">ASSESSMENT FORM</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('certificate of enrollment', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">CERTIFICATE OF ENROLLMENT</td>
					</tr>
					<tr style="border: solid 1px;">
					...
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('school id', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">SCHOOL I.D</td>
					</tr>
					</table>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col">
					<p style="heigth: 60%;"></p>
					<input class="text-center" style="heigth: 90%; width: 50%;" value="<?php echo strtoupper($client_assistance[1]['fund']);?>"></input><br>
		...
		<div class="row">
			...
			<div class="col ml-md-auto">
				<br><p class="right" style="width: 65%;">Prepared by : &nbsp&nbsp&nbsp&nbsp&nbsp <br>
