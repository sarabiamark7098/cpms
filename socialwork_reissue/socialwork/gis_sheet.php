...
<br>
    ...
    <div class="row" style="font-size: 13px; margin-top: -5px">
        ...
        <div class="col-sm-2" ><input class="form-control input-lg border-dark" type="text" value="<?php echo date("h:i:s"); ?>"></div>
    ...
    <div>
        <table style="width:100%;font-size: 13px">
            <tr>
                <th width="17%" height="10"></th>
                <th width="32%" height="10">PURPOSE</th>
                <th width="17%" height="10">AMOUNT OF ASSISTANCE</th>
    ...
    <div class="row" style="font-size: 12px">
        ...
        <div class="col-sm-3 col-xs-3" >Reviewed and Approved by:</div>
    ...
    <div class="row text-center" style="margin:-80px; margin-left: 1px">
        <div class="col"><input type="text" style="font-weight: bold; text-transform:uppercase;" class="ubos" id="soc_work" value="<?php echo strtoupper($soc_workFullname); ?>"><br><p>CIU-Social Worker</p></div>
        <div class="col-sm-3">
            <div style="border-bottom:1px solid #000000; height: 25px;width:100%; margin-bottom: -15px" class="text-center">
                <p id="signature" style="font-weight: bold;margin-bottom: -5px; text-transform:uppercase;"></p>
                <p style="margin-top:5px;padding-top:8px" id="s_position"></p>
            </div>
        </div>
        <div class="col-1"></div>
        <div class="col-sm-4"><input class="ubos" type="text" id="client" style="width: 200px;" value="<?php echo $client["firstname"]." ". strtoupper($client["middlename"][0]) .". ". $client["lastname"]." ". $client['extraname']; ?>">
        <br><p>Client</p>
        </div>
        <div class="col"></div>
    </div>
