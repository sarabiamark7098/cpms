	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				...
				&nbsp&nbsp has been eligible for <?php echo $client_assistance[2]['type']?> for &nbsp&nbsp 
		...
		<div class="row">
			<div class="col-12">
				...
				<input class="text-center" style="heigth: 100%; width: 40%;" value="<?php echo $client_assistance[2]['purpose']?>"></input> 
				&nbsp&nbsp in the amount of 
				<input class="text-center" style="heigth: 100%; width: 80%;" value="<?php echo $user->toWord($client_assistance[2]['amount'])?>"></input> 
				&nbsp&nbsp PHP 
		...
		<div class="row">
			...
			<div class="col">
				<p style="heigth: 60%;"></p>
				<input class="text-center" style="heigth: 90%; width: 50%;" value="<?php echo strtoupper($client_assistance[2]['fund']);?>"></input><br>
