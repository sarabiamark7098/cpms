...
<?php
	...
	if(isset($_POST['decline'])){
        $result = $user->decline_client_to_socialWork_Serving($_GET['id'],$_SESSION['userId']);
        if($result){
            echo "<script>alert('Client Successfully declined!');</script>";
            echo "<script>window.location='../socialwork/draft.php';</script>";
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in show active" id="decline" role="tabpanel">
                        ...
                        <?php
							...
							echo '<div class="body">
							  <form class="form-group" action="declineClient2.php?id='.$transid.'" method="POST">
                    ...
                    <div class="tab-pane fade" id="ViewHistory" role="tabpanel">
						      <!--Body-->
								...
								<table class="table table-fixed table-striped table-hover highlight responsive-table" style="width: 100%; margin: 2% 0% 0% 0%;">
									...
									<?php
										$id = $_SESSION['tracker'];
										$history = $user->show_client_history_data($id);
										if($history){
