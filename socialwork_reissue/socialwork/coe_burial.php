<div id='burial' style="page-break-after:always">
<br><br>
	<div class="container">
		<div class="row">
			<div class="col">
		...
		<div class="row">
			...
			<div class="col-5">
				<table style="width: 100%;;">
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('death certificate', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">REGISTERED DEATH CERTIFICATE</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('funeral', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">FUNERAL CONTRACT</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('transfer', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">PERMIT TO TRANSFER</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('quarantine', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">QUARANTINE PERMIT</td>
					</tr>
					<tr style="border: solid 1px;">
						<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('promissory', $record['document'])?>"></input></td>
						<td style="width: 80%;" class="text-center">PROMISSORY NOTE</td>
					</tr>
				</table>
			</div>
		</div>
