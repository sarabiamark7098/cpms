	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				...
				<input class="text-center" value="<?php echo empty($client_assistance[2]['type'])? $client_assistance[1]['type']:$client_assistance[2]['type'] ?>" style="heigth: 100%; width: 30%;;border:none;border-bottom: 1px solid #000000;"></input> 
				&nbsp&nbsp for purpose of &nbsp 
				<input class="text-center" style="heigth: 100%; width: 40%;;border:none;border-bottom: 1px solid #000000;" value="<?php echo empty($client_assistance[2]["type"])? $client_assistance[1]["purpose"]: $client_assistance[2]["purpose"]?>"></input> 
				&nbsp&nbsp in the amount of 
				<input class="text-center" style="heigth: 100%; width: 70%;;border:none;border-bottom: 1px solid #000000;" value="<?php echo empty($client_assistance[2]["type"])? $user->toWord($client_assistance[1]["amount"]) : $user->toWord($client_assistance[2]["amount"]);?>"></input> 
				&nbsp&nbsp PHP 
				<input class="text-center" style="heigth: 100%; width: 20%;;border:none;border-bottom: 1px solid #000000;" value="<?php echo empty($client_assistance[2]["type"])? $client_assistance[1]["amount"]: $client_assistance[2]["amount"] ?>"></input></p>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-2.">
			...
			<div class="col">
				...
				echo ", ". $client["subCategory"] ?>"></input><br>
		...
		<div class="row">
			...
			<?php if(($client_assistance[1]['type']=="Food Subsidy Assistance" && $am > 5000) || (!empty($client_assistance[2]['type'])=="Food Subsidy Assistance" && $am2 > 5000)) {?>
				<div class="col ml-md-auto">
			...
			<?php } elseif(($client_assistance[1]['type']=="Food Subsidy Assistance" && $am <= 5000) || (!empty($client_assistance[2]['type'])=="Food Subsidy Assistance" && $am2 <= 5000)) {?>
				<div class="col ml-md-auto">
