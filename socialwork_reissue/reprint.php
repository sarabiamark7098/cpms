...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="position: fixed; width: 100%;  z-index:100; background: #6d7fcc;">
        <a href="../socialwork/home.php"><img src="../images/dswd-logo_final.png" class="img-responsive" alt="unkown" width="200" height="55"></a>
	...
	<script>
        ...
        <div class="row">
            <div class="col-1"></div>
            <div class="col"> <a type="button" href="reissue.php" class="btn btn-primary btn-block no-print"><span class="fa fa-reply"></span> BACK</a></div>
            <div class="col-9"></div>
        </div>
    <br><br><br>
    <div class="container">
