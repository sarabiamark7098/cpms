	<div id='non_food' style="page-break-after:always">
	<br><br>
	<div class="container">
		<div class="row">
			<div class="col">
		...
		<div class="row">
			<div class="col">
				...
				<input class="text-center" style="heigth: 100%; width: 35%;text-transform: uppercase;" value="<?php echo $coename?>"></input>
				, &nbsp 
				<input class="text-center" style="heigth: 100%; width: 15%;" value="<?php echo $client["sex"]?>"></input>
				, &nbsp 
				<input class="text-center" style="heigth: 100%; width: 10%;" value="<?php echo $clientAge?>"></input>
				&nbsp&nbsp year/s old and presently residing at &nbsp&nbsp 
				<input class="text-center" style="heigth: 100%; width: 80%; text-transform:uppercase" value="<?php echo $address["client"]?>"></input> 
				&nbsp&nbsp has been eligible for financial assistance for &nbsp&nbsp 
				<input class="text-center" style="heigth: 100%; width: 45%;" value="<?php echo ($client['relation']=='Self'?"SELF":$coebname)?>"></input> 
		...
		<div class="row">
			...
			<table style="width: 90%;">
					...
					<tr style="border: solid 1px;">
						...
						<td style="width: 80%;" class="text-center">VALID I.D PRESENTED: &nbsp <u id="food_i_pres_id"><?php echo $coe['id_presented']?></u></td>
					</tr>
					<tr style="border: solid 1px;">
		...
		<div class="row">
			<div class="col">
				...
				<input class="text-center" value="<?php echo $client_assistance[1]["type"]?>" style="heigth: 100%; width: 30%;"></input> 
				&nbsp&nbsp in the amount of 
				<input class="text-center" style="heigth: 100%; width: 70%;" value="<?php echo $user->toWord($client_assistance[1]["amount"]);?>"></input> 
				&nbsp&nbsp PHP 
				<input class="text-center" style="heigth: 100%; width: 20%;" value="<?php echo $client_assistance[1]["amount"]?>"></input></p>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-2.">
			...
			<div class="col">
				...
				<input class="text-center" style="heigth: 80%; width: 50%;" value="<?php echo strtoupper($client["mode_admission"])?>"></input>
			</div>
		</div>
		<div class="row">
			<div class="col-5">
			...
			<div class="col ml-md-auto">
				...
				<input class="text-center" style="heigth: 90%; width: 75%; margin-left:25px; font-weight:bold;text-transform: uppercase;" value="<?php echo $soc_worker['empfname'].' '.$soc_worker['empmname'][0].'. '.$soc_worker['emplname'].' '.$soc_worker['empext']?>"/> <br>
				<input class='text-center' style="heigth: 90%; width: 75%; margin-left:25px; border:none" value="CIU-Social Worker"/></p>
		...
		<div class="row">
			<div class="col-5">
				<br><p>Conforme:<br><br>
				<input class="text-center" style="heigth: 90%; width:100%;font-weight:bold;text-transform: uppercase;" value="<?php echo $coename?>"/>
			...
			<div class="col ml-md-auto">
				<?php if($am <= 5000){ ?>
					...
					<input class="text-center" style="heigth: 90%; width: 75%; margin-left:25px; font-weight:bold;text-transform: uppercase;" value="<?php echo $signatoryName?>"/><br>
					<input class="text-center" style="heigth: 90%; width: 75%; margin-left:25px;  border:none" value="<?php echo $signatory['position']?>"/></p>
				<?php } elseif($am > 5000){ ?>
		...
		<div class="row">
			...
			<div class="col ml-md-auto">
				<?php if($am > 5000){ ?>
					<br><p class="right" style="width: 65%;">Approved by : &nbsp&nbsp&nbsp&nbsp&nbsp <br><br>
					<input class="text-center" style="heigth: 90%; width: 75%; margin-left:25px; font-weight:bold;text-transform: uppercase;" value="<?php echo $reconsignatoryName?>"/><br>
					<input class="text-center" style="heigth: 90%; width: 75%; margin-left:25px;  border:none" value="<?php echo $reconsignatory['position']?>"/></p>
				<?php } ?>
			</div>
		</div>
	</div>
