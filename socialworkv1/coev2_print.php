...
<style>
    ...
    <div class="container" id="coev2_print" style="font-size:12px; padding:0%;">
        ...
        <div style="margin-top: 5px; font-size: 14px; text-transform: justify">
			...
			value="<?php echo !empty($client['b_lname'])?((!empty($client["b_region"])?explode(" (",$client["b_region"])[0]:"").(!empty($client["b_province"])?", ".explode(" /",$client["b_province"])[0]:"").(!empty($client["b_municipality"])?", ".explode(" /",$client["b_municipality"])[0]:"").(!empty($client["b_barangay"])?", ".explode(" /",$client["b_barangay"])[0]:"").(!empty($client["b_street"])?", ".$client["b_street"]:"")):((!empty($client["client_region"])?explode(" (",$client["client_region"])[0]:"").(!empty($client["client_province"])?", ".explode(" /",$client["client_province"])[0]:"").(!empty($client["client_municipality"])?", ".explode(" /",$client["client_municipality"])[0]:"").(!empty($client["client_barangay"])?", ".explode(" /",$client["client_barangay"])[0]:"").(!empty($client["client_street"])?", ".$client["client_street"]:"")) ?>" /><br>
            ...
            <div class="col " style="border: 1px solid black;padding-top: 8px;margin-top: 3px; padding-bottom: 3px;">
                ...
                <div class="row" style="font-size: 14px;">
                    <div class="col" style="padding-top: 0px; margin-top: -8px;">
                        ...
                        <input class="text-center" style="width: 100%;height:20px; font-size: 11px; padding:0; border:0; border-bottom: 1px solid black;" type="text" value='<?php echo $record['id_presented']; ?>'><br>
        ...
        <div style="margin-top: 10px; font-size: 14px; text-align:justify;">
            The client is hereby recommended to receive <input class="text-center" style="border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 20px; width: 25%;" value="<?php echo strtoupper($client_assistance[1]['type']);strtoupper($client_assistance[1]['type']); ?>" /> assistance for <input class="text-center" style="border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 20px; width: 35%; text-transform: capitalize;" value="<?php echo $client_assistance[1]['purpose']; ?>" /><br> 
...
<br>
        ...
        <div class="row" style="font-size: 15px; line-height: 15px;">
            ...
            <div class="col text-center">
                <input class="text-center" style="width: 100%; font-size: 15px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo (strtolower($mode1) == "cav"?strtoupper($GISsignatoryName):strtoupper($GLsignatoryName)) ?>'>
                <!-- <b>CID/CIU/CIS/SWTL</b> -->
                <b><?php echo (strtolower($mode1) == "cav"?strtoupper($GISsignatoryPosition):strtoupper($GLsignatoryName)) ?></b>
                <p>Signature Over Printed Name</p>
            </div>
        </div>
