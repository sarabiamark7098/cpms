    ...
    <div style="">
        ...
        <div class="container" style="">
            ...
            <div class="row">
                ...
                ?>
                <div class="col-5 ml-auto text-right" style="font-family: Arial;">
            ...
            <div class="row">
                <div class="col-6">
                    <div style="height: 150px;width:100%; margin-bottom: 15px">
                        <input id="signatory" style="font-weight: bold;text-transform:uppercase;width:100%;border:none;" value="<?php echo explode('-', $signatoryGLNamePos)[0] ?>"><br>
            ...
            <p class="cn " style="font-size:18Opx ">
                ...
                if(!empty(explode('-', $signatoryGLNamePos)[3])){
    				$signatory = explode('-', $signatoryGLNamePos)[3];
                }else{
				...
				$encoder = $user->getencoderINI($client['encoded_encoder']);
				 echo '<small>'. strtoupper($signatory) ."/". (!empty($COEsignatoryini)?strtoupper($COEsignatoryini) ."/":"") ."". strtoupper($ftsignatoryini) ."/".  strtolower($soc_worker) ."/". strtolower($encoder) .'</small>';
            ?>
            </p>
        </div>
