...
<html>
    ...
    <body>
                        ...
                        <div class="card">
                            <div class="card border-info mb3" style="width:100%;">
                                ...
                                <div class="card-body">
                                    <div class="container" style="font-size: 15px;">
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:3px;"><input type="checkbox" class="lg" name="fb" id="fb" value="1" <?php echo (strtolower($client_assistance[1]['type'])=="burial assistance"?($client_assistance[1]['if_burial']==1 ? "checked": ""):"") ?>></div>
                                            <div class="col-11"> Funeral Bill</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1" style="margin-top:3px;"><input type="checkbox" class="lg" name="toc" id="toc" value="2" <?php echo (strtolower($client_assistance[1]['type'])=="burial assistance"?($client_assistance[1]['if_burial']==2 ? "checked": ""):"") ?>></div>
                            ...
                            <div class="card border-info mb3" style="width:100%;">
                                ...
                                <div class="card-body">
                                    <div class="container" style="font-size: 15px;">
                                        ...
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:3px;"><input type="checkbox" class="lg" name="financial" id="financial" value="4" <?php echo ($client_assistance[1]['financial']==4 ? "checked": "") ?>></div>
                                            <div class="col-11"> Financial Assistance</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                    ...
                    <div class="card border-info mb3" style="width:100%;">
                        ...
                        <div class="card-body text-dark">
                            <div class="row">
                                ...
                                <label class="col-sm-2 label text-right" style="font-size: 18px">SERVICES:</label>
                                <div class="col-3"><input type="checkbox" id="group" class="col-lg-1" name="psy" value="Psychosocial" <?php echo $gis['service1']==0? "": "checked"; ?> required> &emsp; Psychosocial</div>
                            </div><br>
                            <div class="row">
                                <label class="col-sm-3 label text-left" style="font-size: 20px">Mode of Admission</label>
                                <div class="col-sm-3">
                                ...
                                <div class="col-2"></div>
                                <div class="col-3"><input type="checkbox" id="group" class="col-lg-1" name="ref" value="Referral" <?php echo $gis['service3']==0? "": "checked";; ?> required> &emsp; Referral Services</div>
        ...
        if (isset($_POST['save'])) {
            ...
            if(isset($_POST['financial'])){$financial = 4;}
            ...
            $user->insertGIS($empid, $trans_id, $id, $p1, $p2, $p3, $rb1, $rb2, $rb3, $e1, $e2, $e3, $t1, $t2, $t3, $b1, $b2, $b3, $s1, $s2, $s3, $s4, $ref_name,
        ...
        if (isset($_POST['update'])) {
            ...
            //once save the data of new -> client
            $user->updateGIS($empid, $trans_id, $id, $p1, $p2, $p3, $rb1, $rb2, $rb3, $e1, $e2, $e3, $t1, $t2, $t3, $b1, $b2, $b3, $s1, $s2, $s3, $s4, $ref_name,
            $type1, $pur1, $a1, $m1, $f1,$type2, $pur2, $a2, $m2, $f2, $mode_ad, $num, $gis_opt, $prob, $ass, $signatoryGIS, 
            $fund1, $fund2, $fund3, $fund4, $fund5, $targets, $subcat, $others_subcat, $if_medical, $if_burial, $financial, $material);
        }
    ...
    <script type="text/javascript">
	    ...
	    $(function () {
            ...
            if(type.toLowerCase()=="medical assistance") {
                $("#medical_show").show();
                $("#burial_show").hide();
            } else if (type.toLowerCase()=="burial assistance") {
                $("#medical_show").hide();
                $("#burial_show").show();
            } else {
                $("#medical_show").hide();
