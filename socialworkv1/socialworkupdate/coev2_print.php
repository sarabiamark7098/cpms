...
<style>
    ...
    <div class="container" id="coev2_print" style="font-size:12px; padding:0%;">
            ...
            <div class="col " style="border: 1px solid black;padding-top: 8px;margin-top: 3px; padding-bottom: 3px;">
                ...
                <div class="row" style="font-size: 14px;">
                    <div class="col" style="padding-top: 0px; margin-top: -8px;">
                        ...
                        <input class="text-center" style="width: 100%;height:20px; font-size: 11px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo $record['id_presented']?>'><br>
        ...
        <div style="margin-top: 10px; font-size: 14px; text-align:justify;">
			...
			<input class="text-center" style="border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 20px; width: 6%;" value="AICS FUND <?php echo date("Y", $client['date_accomplished']) ?>" />
        </div>
<br>
        <!-- Signatory -->
