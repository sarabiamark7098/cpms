	...
	<div class="container">
		...
		<div class="row">
			<div class="col">
				...
				, &nbsp 
				<input class="text-center" style="heigth: 100%; width: 15%;text-transform: uppercase;o" value="<?php echo $client["sex"]?>"></input>
				, &nbsp 
		...
		<div class="row">
			<div class="col-12">
				...
				<b class="text-center" style="heigth: 100%; padding:5px 5px; border-bottom:1px solid black;"><?php echo $amountToWord2?></b>
				&nbsp&nbsp PHP 
				<input class="text-center" style="heigth: 100%; width: 13%;" value="<?php echo  $client_assistance[2]['amount']?>"></input></p>
			</div>
		</div>
		<div class="row">
			<div class="col-3">
