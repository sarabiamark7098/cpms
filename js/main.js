...
function getGISvalue(){
    ...
    var arr = {"pangan1": pangan1, "pangan2": pangan2, "pangan3": pangan3, "edad1": edad1, "edad2": edad2, "edad3": edad3,
                "trabaho1": trabaho1, "trabaho2": trabaho2, "trabaho3": trabaho3, "sahod1": sahod1, "sahod2": sahod2, "sahod3": sahod3, 
                "type1": type1, "type2" : type2, "purpose1": purpose1, "purpose2": purpose2, "amount1": amount1, "amount2" : amount2, 
                "moa1": moa1, "moa2": moa2, "fundSource1": fundSource1, "fundSource2":fundSource2, "problem": problem, "soc_ass" : soc_ass, 
                "service": service , "c_num" : c_num, "approved" : approved, "mode_ad" : mode_ad, "ref_name": ref_name
    };
...
function getGLvalue(){
    ...
    var arr = { "c_no": c_no, "addressee" : addressee, "pos": pos, "c_name" : c_name, "c_add": c_add, "signatory": signatory
    };
        return arr;
}
function getCAVvalue(){
    ...
    var array = { "cash_add": cash_add, "payee": payee
    };
        return array;
}
