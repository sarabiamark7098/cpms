...
<style>
    ...
    <div class="container" id="coev2_print" style="font-size:12px; padding:0%;">
        ...
        <div class="row">
            <div class="col-12" style="text-align: center;">
                ...
                <div class="row">
                    <div class="col-3"></div>
                    <div class="col-6">
                        <p style="font-size: 18px; margin-top: -10px;">(Food Assistance)</p>
                    </div>n
                    <div class="col-3"></div>
                </div>
            </div>
        ...
        <div style="margin-top: 10px; font-size: 14px; text-align:justify;">
			...
			<input class="text-center" style="border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 20px; width: 13%;" value="<?php echo (($client['program_type']==1)? 'AKAP' : 'AICS') ?> Fund <?php echo Date('Y')?>" />
        </div>
<br><br>
        <!-- Signatory -->
        ...
        <div class="row" style="font-size: 15px; line-height: 15px;">
            ...
            <div class="col text-center">
                <input class="text-center" style="width: 100%; font-size: 15px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo (strtolower($mode1) == "ds"?$GISsignatoryName:$GLsignatoryName) ?>'>
                <!-- <b>CID/CIU/CIS/SWTL</b> -->
                <b><?php echo (strtolower($mode1) == "ds"?$GISsignatoryPosition:$GLsignatoryPosition) ?></b>
                <p>Signature Over Printed Name</p>
            </div>
        </div><br>
