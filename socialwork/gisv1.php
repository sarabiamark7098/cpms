                                ...
                                <div class="card-body">
                                    <div class="container" style="font-size: 15px;">
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:17px;"><input type="checkbox" class="lg" name="fhona" id="fhona" value="FHONA"></div>
                                            <div class="col-11"> FAMILY HEADS, AND OTHER NEEDY ADULTS (FHONA)</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:17px;"><input type="checkbox" class="lg" name="wedc" id="wedc" value="WEDC"></div>
                                            <div class="col-11"> WOMEN IN ESPECIALLY DIFFICULT CIRCUMSTRANCES (WEDC)</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:3px;"><input type="checkbox" class="lg" name="pwd" id="pwd" value="PWD"></div>
                                            <div class="col-11"> PERSON WITH DISABILITIES (PWD)</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:3px;"><input type="checkbox" class="lg" name="youth" id="youth" value="YOUTH"></div>
                                            <div class="col-11"> YOUTH</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:3px;"><input type="checkbox" class="lg"  name="sc" id="sc" value="SC"></div>
                                            <div class="col-11"> SENIOR CITIZEN (SC)</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1" style="margin-top:3px;"><input type="checkbox" class="lg"  name="plwhiv" id="plwhiv" value="PLWHIV"></div>
                        ...
                        <div class="form-group row">
                            <div class="card border-info mb3" style="width:100%;">
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:5px;"><input type="checkbox" class="lg" name="solo" id="solo" value="SOLO PARENTS"></div>
                                            <div class="col-11"> SOLO PARENTS</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:5px;"><input type="checkbox" class="lg" name="ip" id="ip" value="INDIGENOUS PEOPLE"></div>
                                            <div class="col-11"> INDIGENOUS PEOPLE</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:5px;"><input type="checkbox" class="lg" name="drug" id="drug" value="RECOVERING PERSON WHO USED DRUGS"></div>
                                            <div class="col-11"> RECOVERING PERSON WHO USED DRUGS</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:5px;"><input type="checkbox" class="lg" name="4ps" id="4ps" value="4PS DSWD BENEFICIARY"></div>
                                            <div class="col-11"> 4PS DSWD BENEFICIARY</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:5px;"><input type="checkbox" class="lg"  name="dwell" id="dwell" value="STREET DWELLERS"></div>
                                            <div class="col-11"> STREET DWELLERS</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:5px;"><input type="checkbox" class="lg" name="mental" id="mental" value="PSYCHOSOCIAL/MENTAL/LEARNING DISABILITY"></div>
                                            <div class="col-11"> PSYCHOSOCIAL/MENTAL/LEARNING DISABILITY</div>
                                        </div>
                                        <div class="row" style="margin-bottom:7px;">
                                            <div class="col-1" style="margin-top:5px;"><input type="checkbox" class="lg" name="asylum" id="asylum" value="STATELESS PERSONS/ASYLUM SEEKERS/REFUGEES"></div>
                                            <div class="col-11"> STATELESS PERSONS/ASYLUM SEEKERS/REFUGEES</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1" style="margin-top:5px;"><input type="checkbox" style="padding" class="lg" name="osc" id="osc" value="OTHERS"></div>
                                            <div class="col-11"> OTHERS: <input type="text" class="lg" style="border-radius: 3px 3px 3px 3px; width: 60%; height:23px;" name="osc_cal" id="pres"></div>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                    ...
                    <div class="card border-info mb3" style="width:100%;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2"><input class="form-control" id="rb2" name="rb2" type="text"    value="<?php echo empty($client_fam[3]) ? "" : $client_fam[3]['relation_bene'] ?>"></div>
                    ...
                    <div class="card border-info mb3" style="width:100%;">
                        ...
                        <div class="card-body text-dark">
                            ...
                            <div class="row">
                                ...
                                <div class="col"><input type="checkbox" id="group" class="col-lg-1" name="leg" value="Legal Assistance" <?php echo $gis['service2']==0? "": "checked"; ?> required> Legal Assistance</div>
                            ...
                            <div class="row"> 
                                ...
                                <div class="col"><input class="form-control money" id="a1" name="a1" <?php echo empty($client_assistance[1])? "" : "onkeyup='verifyfirst()'" ?> required value="<?php echo empty($client_assistance[1])? "" : $client_assistance[1]['amount']; ?>"></div>
                                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="text" id="f2" value="CURRENT FUND" hidden>
                                    <input list="chargings" class="form-control" id="fundf2" name="f2" <?php echo empty($client_assistance[2]) ? "" : "onkeyup='verifysecond()'" ?> type="text" value="<?php echo empty($client_assistance[2]) ? "" : $client_assistance[2]['fund'] ?>"/>
                                </div> 
                                <div class="col-1">
                                </div> 
                            </div>
