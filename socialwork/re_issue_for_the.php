                                        ...
                                        <div class="card-body">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-10">
                                                    <input list="signatory" type="text" class="form-control mr-sm-2 for_the" id="for_the" name="for_the" placeholder="Select For the Signatory" value="<?php echo (empty($gl['for_the_id']) ? '' : $user->getSignatoryFullname($gl['for_the_id'])) ?>" autocomplete="off" required>
