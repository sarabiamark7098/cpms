...
<br><br>
	<div class="container">
		...
		<div class="row">
			<div class="col">
				<br><p>This is to certify that &nbsp 
		...
		<div class="row">
			...
			<div class="col-5">
				...
				<tr style="border: solid 1px;">
					<td style="border-right: solid 1px; width: 20%;"><input class="text-center" style="width: 100%; border: none;" value="<?php echo $user->coe_check('death summary', $record['document'])?>"></input></td>
