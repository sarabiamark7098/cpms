            ...
            <b> &emsp; Type of Disability</b><br>
                <div class="row">
                    ...
                    <div class="col-6" style="font-size:11px; margin:0%; padding:0%;padding-top:5px;">
                        ...
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:2px;border: 1px solid black;margin-bottom: 5px;" value="<?php echo ($gis['type_of_disability'] == 10? '&#x2714;':'') ?>" />&nbsp;Rare Disease
                    </div>
                </div>
            </div>
        </div>
