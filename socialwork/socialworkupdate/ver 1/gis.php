...
if (isset($_GET['id'])) {
    ...
    $soc_workFullname = $soc_worker['empfname'] . ' ' . $soc_worker['empmname'][0] . '. ' . $soc_worker['emplname'] . ' ' . $soc_worker['empext'];
    ...
    $address['beneficiary'] = $client['b_street'] . ", " . $brgy[0] . ", " . $city[0] . " City, " . $province[0];
    if(!empty($client_assistance[1]['amount'])){
        $updateamountinfive = $user->comparefivedays($client['date_accomplished']);
    }else{
        $updateamountinfive2 = 2;
    }

    if(!empty($client_assistance[2]['amount'])){
        $updateamountinfive2 = $user->comparefivedays($client['date_accomplished']);
    }else{
        $updateamountinfive2 = 2;
    }
}
...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="position: fixed; width: 100%; z-index:100; background: #6d7fcc;">
	 ...
	 <!--Input Form-->
     <br><br><br><br>
   <div class="container" style="position: static"><br>
        <div>
			...
			<button class="btn btn-success btn-block" onclick="backupdate('<?php echo $_GET['id']?>')" data-id="<?php echo $id ?>"><span class='fa fa-arrow-left'></span> Cancel</button></div>
			<div class="col" ></div><div class="col" ></div><div class="col" ></div><div class="col" ></div>
			</div>
        </div><br>
        <!--Fucking inputs-->
        <form id="up" action="gis.php?id=<?php echo $_GET['id'] ?>&updated=1" method="post" >
        <small>(Please Save/Update before printing)</small>
                ...
                <div class="card border-info mb3" style="width:100%;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col"><input class="form-control" id="p1" name="p1" type="text"    value="<?php echo empty($client_fam[1]) ? "" : $client_fam[1]['name'] ?>" readonly></div>
                            <div class="col"><input type= "number" class="form-control" id="e1" name="e1" max="99" onKeyPress="if(this.value.length==3) return false;" value="<?php echo empty($client_fam[1])||$client_fam[1]['age']==0? "" : $client_fam[1]['age'] ?>"  readonly></div>
                            <div class="col"><input class="form-control" id="t1" name="t1" type="text"    value="<?php echo empty($client_fam[1]) ? "" : $client_fam[1]['occupation'] ?>" readonly></div>
                            <div class="col"><input class="form-control" onkeypress="return rangeKey(event)" id="b1" name="b1" value="<?php echo empty($client_fam[1]) ? "" : $client_fam[1]['salary'] ?>" readonly></div>  
                        </div><br>
                        <div class="row">
                            <div class="col">Person 2:</div>
                            <div class="col"><input class="form-control" id="p2" name="p2" type="text"    value="<?php echo empty($client_fam[2]) ? "" : $client_fam[2]['name'] ?>" readonly></div>
                            <div class="col"><input type= "number" class="form-control" id="e2" name="e2" max="99" onKeyPress="if(this.value.length==3) return false;" value="<?php echo empty($client_fam[2])||$client_fam[2]['age']==0? "" : $client_fam[2]['age'] ?>" readonly></div>
                            <div class="col"><input class="form-control" id="t2" name="t2" type="text"    value="<?php echo empty($client_fam[2]) ? "" : $client_fam[2]['occupation'] ?>" readonly></div>
                            <div class="col"><input class="form-control" onkeypress="return rangeKey(event)" id="b2" name="b2" value="<?php echo empty($client_fam[2]) ? "" : $client_fam[2]['salary'] ?>" readonly></div>  
                        </div><br>
                        <div class="row">
                            <div class="col">Person 3:</div>
                            <div class="col"><input class="form-control" id="p3" name="p3" type="text"    value="<?php echo empty($client_fam[3]) ? "" : $client_fam[3]['name'] ?>" readonly></div>
                            <div class="col"><input type= "number" class="form-control" id="e3" name="e3" max="99" onKeyPress="if(this.value.length==3) return false;" value="<?php echo empty($client_fam[3])||$client_fam[3]['age']==0? "" : $client_fam[3]['age'] ?>" readonly></div>
                            <div class="col"><input class="form-control" id="t3" name="t3" type="text"    value="<?php echo empty($client_fam[3]) ? "" : $client_fam[3]['occupation'] ?>" readonly></div>
                            <div class="col"><input class="form-control" onkeypress="return rangeKey(event)" id="b3" name="b3" value="<?php echo empty($client_fam[3]) ? "" : $client_fam[3]['salary'] ?>" readonly></div>  
                        </div>
                    </div>
                </div> 
            </div>
                ...
                <div class="card border-info mb3" style="width:100%;">
                    ...
                    <div class="card-body text-dark">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col text-center">MODE ASSISTANCE</div>
                            <div class="col text-center">FUND SOURCE</div> 
                            <div class="col-1 text-center"></div> 
                        </div>
                        <div class="row"> 
                            <div class="col">
                                <input list="types" type="text" id="type1" class="form-control" name="type1" <?php echo empty($client_assistance[1]) ? "" : "onkeyup='verifyfirst()'" ?> required value="<?php echo empty($client_assistance[1]) ? "" : $client_assistance[1]['type'] ?>">
                                <datalist id="types">
                                    ...
                                    <option value="Non-Food Items"></option>
                                    <option value="Other Cash Assistance"></option>
                                </datalist>
                            </div>
                            ...
                            <div class="col"><input class="form-control money" id="a1" name="a1" <?php echo empty($client_assistance[1])? "" : "onkeyup='verifyfirst()'" ?>  value="<?php echo empty($client_assistance[1])? "" : $client_assistance[1]['amount']; ?>"></div>
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <input list="types2" type="text" id="type2" class="form-control" name="type2" <?php echo empty($client_assistance[2]) ? "" : "onkeyup='verifysecond()'" ?> value="<?php echo empty($client_assistance[2]) ? "" : $client_assistance[2]['type']; ?>" onkeyup="typerequire()">
                                <datalist id="types2">
                                    <option value="Food Subsidy Assistance"></option>
                                </datalist>
                            </div>
                            <div class="col"><input class="form-control" id="pur2" name="pur2" <?php echo empty($client_assistance[2]) ? "" : "onkeyup='verifysecond()'" ?> type="text" value="<?php echo empty($client_assistance[2]) ? "" : $client_assistance[2]['purpose']; ?>"></div>
                            <div class="col"><input class="form-control money" id="a2" name="a2" <?php echo empty($client_assistance[2])? "" : "onkeyup='verifysecond()'" ?> value="<?php echo empty($client_assistance[2]) ? "" : $client_assistance[2]['amount']; ?>"></div>
                            <div class="col">
                                <select class="form-control" id="m2" name="m2" <?php echo empty($client_assistance[2]) ? "" : "onkeyup='verifysecond()'" ?> type="text">
                                    <option selected="selected"><?php echo empty($client_assistance[2]['mode']) ? "" : $client_assistance[2]['mode']; ?></option>
                                    <option>GL</option>
                                    <option>CAV</option>
                                    <option>DS</option>
                                </select>
                            ...
                            <div class="col">
                                <input list="chargings" class="form-control" id="f2" name="f2" <?php echo empty($client_assistance[2]) ? "" : "onkeyup='verifysecond()'" ?> type="text" value="<?php echo empty($client_assistance[2]) ? "" : $client_assistance[2]['fund'] ?>"/>
                            </div> 
                            <div class="col-1"> <!--Source of Fund-->
                            </div>
                        </div><br>
            ...
            <div class="form-group row" >
                ...
                <div class="col" ><button type="button" class="btn btn-success btn-block text-white " id="toCOE" onclick="toCoe('<?php echo $_GET['id']; ?>')"><span class='fa fa-arrow-right'></span>&nbsp Next</button></div>
            </div>
        </form>
    </div>
    <div hidden>
...
if (isset($_POST['update'])) {
    ...
    echo $signatoryGIS = $_POST["approved"]; //signatory approved
    $fund1 = "";
    $fund2 = "";
    $fund3 = "";
    $fund4 = "";
    $fund5 = "";
    $fs_data = 0;
    if(!empty($_POST['fsof1']) == $fundsourcedata[1]['fundsource']){
        $fs_data = 1;
    }if(!empty($_POST['fsof2']) == $fundsourcedata[2]['fundsource']){
        $fs_data = 1;
    }if(!empty($_POST['fsof3']) == $fundsourcedata[3]['fundsource']){
        $fs_data = 1;
    }if(!empty($_POST['fsof4']) == $fundsourcedata[4]['fundsource']){
        $fs_data = 1;
    }if(!empty($_POST['fsof5']) == $fundsourcedata[5]['fundsource']){
        $fs_data = 1;
    }
    if(!empty($_POST['fsof1'])){
    ...
    $user->updateGISbySocialWork($empid, $trans_id, $id, $p1, $p2, $p3, $e1, $e2, $e3, $t1, $t2, $t3, $b1, $b2, $b3, $s1, $s2, $s3, $s4, $ref_name,
    $type1, $pur1, $a1, $m1, $f1,$type2, $pur2, $a2, $m2, $f2, $mode_ad, $num, $gis_opt, $prob, $ass, $signatoryGIS, $fund1, $fund2, $fund3, $fund4, $fund5, $fs_data);
}
