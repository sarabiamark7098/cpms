<?php 
    ...
    if(isset($_GET['confirmdone'])){
        if($_GET['confirmdone'] == 1){
            ...
            $user->doneupdate($_GET["id"],$_GET['transid']);
        }
    }
    if(isset($_GET['id'])){
        ...
        if(!empty($signatoryGL)){
            $signatoryGLNamePos = strtoupper($signatoryGL['first_name'] ." ". (!empty($signatoryGL['middle_I'])?$signatoryGL['middle_I'] .". ":""). $signatoryGL['last_name'] ."-". $signatoryGL['position']);
        }
        //ADDRESS
        $c_add = '';
        $b_add = '';
       ...
       //gipangkwaan og '-'
        ...
        if(!empty($gl['for_the_id'])){
            ...
            if ($gl['for_the_id'] != $client['signatory_id'] && $gl['for_the_id'] != $client['signatory_GL']) {
...
<html>
    ...
    <br><br>
        <form action="last.php?id=<?php echo $_GET['id']?>" method="post">
                                        ...
                                        <div class="col">
                                            <div class="input-group input-group-lg">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="inputGroup-sizing-sm"><i>'. $user->glfundsource($_GET['id']) .'-</i></span>
                                                </div>
                                                <input type="text" class="form-control mr-sm-2 b" id="c_no" value="'.$GLid.'" name="c_no" placeholder="Control No." readonly>
            ...
            ?>
            <div class="row">
                        <?php if((strtolower($client_assistance[1]['type']) == "other cash assistance") && ($client_assistance[2]['type'] == "") || (strtolower($client_assistance[1]['type']) == "non-food items") && ($client_assistance[2]['type'] == "")){ ?>
    ...
    <?php 
        ...
        if(isset($_POST['update'])){
            ...
            if( $if1 || $if2 ){
                ...
                $user->updateGLCashbyEncoder($_GET['id'], $sd_officer, $c_no, $signatory, $addressee, $a_pos, $forthe, $cname, $add, $tomention);
                ...
                if((strtolower($mode1) == "cav" || strtolower($mode2) == "cav")){
                    ...
                    if(empty($cash)){
                        ...
                        $user->updateCashbyEncoder($_GET['id'], $sd_officer);
                    }
                }else{
                    ...
                    if(empty($gl)){
                        ...
                        $user->updateGLbyEncoder($_GET['id'], $c_no, $signatory, $addressee, $a_pos, $forthe, $cname, $add, $tomention);
                    }
                }
