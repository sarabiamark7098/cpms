    ...
    <body>
        ...
        <div class="container"><br><br>
            <form action="last.php?id=<?php echo $_GET['id']?>" method="post">
                ...
                ?>
                <div class="row">
                    <div class="col"><input type="button" class="btn btn-<?php echo (empty($gl['control_no']) && empty($cash['sd_officer']))?"secondary":"primary" ?> btn-block" value="Print GIS" name="printgis" onclick="printGISinCE()"<?php echo (empty($gl['control_no']) && empty($cash['sd_officer']))?"disabled":"" ?> ></div>
					<div class="col"><input type="button" class="btn btn-<?php echo (empty($gl['control_no']) && empty($cash['sd_officer']))?"secondary":"primary" ?> btn-block" value="Print CE" name="printce" onclick="printCOE()"<?php echo (empty($gl['control_no']) && empty($cash['sd_officer']))?"disabled":"" ?> ></div>
					<div class="col">
