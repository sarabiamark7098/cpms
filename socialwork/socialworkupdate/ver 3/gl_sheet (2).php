        ...
        <div class="container">
            ...
            <div class="justify" style="font-family: Arial; font-size: 24px;">
                ...
                if(strtolower($client['relation']) == "self"){
					...
					*/
					echo '<p class="">This has reference to the request for the <b>'. $client_assistance[1]['type'] .'</b> of the client,
					<b>'.strtoupper($name).'</b>, <b>'. strtoupper($client["sex"]) .'</b>, <b>'. strtoupper($age_client) .'</b>, '. ucwords(strtolower($c_add)) .'.</p>';
					...
					echo "<p><input type='radio' style='height: 20px; width:20px;'> &emsp; Guarantee Letter (GL) from the DSWD with your company's 'recieved' stamp<br>
					...
					*/
					echo '<p class="">This has reference to the request for the <b>'. $client_assistance[1]['type'] .'</b> of the client,
					<b>'.strtoupper($name).'</b>, <b>'. strtoupper($client["sex"]) .'</b>, <b>'. strtoupper($age_client) .'</b>, '. ucwords(strtolower($c_add)) .', for the beneficiary, <b>'.strtoupper($bname).'</b> of '. (($b_add!=$c_add)?ucwords(strtolower($b_add)):"the same address") .'.</p>';
