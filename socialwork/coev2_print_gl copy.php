...
<style>
    ...
    <div class="container" id="coev2_print" style="font-size:15px; padding:0%;">
        ...
        <div class="row">
            <div class="col-12" style="text-align: center;">
                ...
                <div class="row">
                    <div class="col-3"></div>
                    <div class="col-6">
                        <p style="font-size: 18px; margin-top: -10px;">(Guarantee Letter)</p>
                    </div>
                    <div class="col-3"></div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="row" style="font-size: 15px; margin-top: -20px">
                    ...
                    <div class="col-sm-9">
                        <input class="" style="width: 100%; font-size: 15px; padding:0; text-indent: 8px; border: 1px solid black;" type="text" value='<?php echo $GLid ?>'>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col " style="border: 1px solid black;margin-top: 3px; padding: 0px 0px 4px 0px;">
                ...
                <div class="row" style="font-size: 15px;margin:0px 2px 0px 2px">
                    ...
                    <div class="col" style="padding-top: 0px; margin-top: -8px;">
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('lab request', $record['document'])?>" />&emsp;Laboratory<br>
                        <input class="text-center" type="text" style="font-size:18px;width:18px;height:18px;margin-top:1px;border:1px solid black;" value="<?php echo $user->coe_check('promissory', $record['document'])?>" />&emsp;Promissory Note<br>
        ...
        <div style="margin-top: 10px; font-size: 15px; text-align:justify;">
            ...
            /> PHP <input class="text-center money" style="border: none; border-bottom: 1px solid black; padding:0px; margin:0px; height: 20px; width: 8%;" value="<?php echo $client_assistance[1]['amount']; ?>" />
        </div>
        <br><br>
        <div class="row">
        ...
        <div class="row" style="font-size: 16px; line-height: 15px;">
            <div class="col text-center">
                <input class="text-center" style="width: 100%; font-size: 16px; padding:0; border:none; border-bottom: 1px solid black;" type="text" height="30px" value='<?php echo ((!empty($client["firstname"])?$client["firstname"]." ":"") . (!empty($client["middlename"])?$client["middlename"][0].". ":""). (!empty($client["lastname"])?$client["lastname"]." ":"") . (!empty($client["extraname"])?$client["extraname"]." ":"")) ?>'>
