                ...
                <div class="row" style="border: solid 1px black;">
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <p class="header" style="margin-left:-15px; margin-right:-15px; text-indent: 14px;"><b style="font-size: 15px">
                                        <input class="check-box text-center" style="width: 20px; height: 20px;  font-size: 14px; padding:0; text-indent: 1px; border: 1px solid black; background-color: #ffffff;" type="text" value='<?php echo !empty($client_assistance[1]['financial'])? '&#x2714;': ""; ?>'>&nbsp;FINANCIAL ASSISTANCE<span style="margin-right: 90px"></span>
                                        ...
                                        <input class="check-box text-center" style="width: 20px; height: 20px;  font-size: 14px; padding:0; text-indent: 1px; border: 1px solid black; background-color: #ffffff;" type="text" value='<?php echo !empty($gis["service5"])||!empty($gis["service6"])? '&#x2714;': ""; ?>'>&nbsp;PSYCHOSOCIAL SUPPORT<span style="margin-right: 10px"></span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4" style="margin-left:-40px; margin-bottom:5px; font-size:14px;">
                                        <div>
                                            <a style="margin-left: 0px"></a>
                                    ...
                                    <div class="col-3" style="margin-left:-60px; font-size:13px;">
                                        <div>
                    ...
                    <div class="col-12">
                        <div class="row" style="height: 200px">
                            <div class="col-6 text-center" style="font-size:14px; line-height: 16px; padding-top: 50px;">
                                <b>Interviewed by:</b><br><br>
                                <input class="text-center" style="width: 60%; border-bottom: 1px solid black;" type="text" value='12312312'><br>
                                <label>Social Worker</label><br>
                                <label style="margin-top: -10px;">(Signature over Printed Name)</label><br>
                                <label style="margin-top: -10px;">License no.:</label><input class="text-center" style="width: 30%; border-bottom: 1px solid black;" type="text" value='12312312'><br>
                            </div>
                            <div class="col-6 text-center" style="font-size:14px; line-height: 16px; margin-top: -15px;"> <br>
                                <p><?php echo $gis["soc_ass"]; ?></p>
                            </div>
                        </div>
                    </div>
